...
function Player(name = '') {
    ...
    Player.prototype.reduceHealth = function (healthLoss) {
    ...
    Player.prototype.usePotion = function (index) {
        ...
        //splice method removes items from an array and returns the removed item(s) as a new array. Thus two things are happinging here:
